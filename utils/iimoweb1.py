...
# ----------------------------------
    ...
    with open("lst_urls.json", "w", encoding='utf-8') as var_jf:
...
# ------------------------------------------------
    ...
    json_dataAL = [str(no)] # ad to list the link numbers by order
    ...
    with open("log_cur_url.json", "w", encoding='utf-8') as var_jf:
...
# open file with all link 
with open('lst_urls.json', encoding='utf-8') as f: 
